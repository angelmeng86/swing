...
@implementation LMCalendarWeekDayView
...
- (void)reload
{
    ...
    for(NSInteger i = 0; i < days.count; ++i){
        NSString *day = days[i];
        if (_manager.settings.weekDayFormat == JTCalendarWeekDayFormatShort) {
            [days replaceObjectAtIndex:i withObject:[[day uppercaseString] substringWithRange:NSMakeRange(0, 1)]];
        }
        else {
